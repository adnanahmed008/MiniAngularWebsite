...
export class CountryService {
  ...
  private lstCountries: ICountry[] = [
    ...
    { name: "Caribbean Netherlands", iso: "bq", code: "5997" },
    ...
    { name: "Congo (DRC) (Jamhuri ya Kidemokrasia ya Kongo)", iso: "cd", code: "243" },
    { name: "Congo (Republic) (Congo-Brazzaville)", iso: "cg", code: "242" },
    ...
    { name: "Pitcairn Islands", iso: "pn", code: "64" },
    ...
    { name: "South Georgia & South Sandwich Islands", iso: "gs", code: "500" },
    ...
    { name: "Svalbard and Jan Mayen", iso: "sj", code: "4779" },
  ...
  getByISOCode(ISO: string) {
    return this.lstCountries.find(country => country.iso == ISO.toLowerCase());
  }
}
